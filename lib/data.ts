...
export const scenarios: Scenario[] = [
  {
    ...
    "whatHappened": "A pod with a custom finalizer never completed termination, blocking kubectl drain. Even after the pod was marked for deletion, the API server kept waiting because the finalizer wasn’t removed.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A bug in a controller created thousands of Custom Resources (CRs) in a tight reconciliation loop. Etcd was flooded, leading to slow writes, and the API server eventually became non-responsive.",
    "diagnosisSteps": [
    ...
    "rootCause": "Bad logic in reconcile loop: create was always called regardless of the state, creating resource floods.",
  ...
  },
  {
    ...
    "whatHappened": "After a kernel upgrade and reboot, a node didn’t appear in kubectl get nodes. The kubelet logs showed registration issues.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The cluster started failing API requests. Etcd logs showed disk space errors, and API server logs showed failed storage operations.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A user added taints (NoSchedule) to all nodes to isolate their app, but forgot to include tolerations in workloads. Other apps stopped working.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A new container image with many layers was deployed. Node’s disk filled up, triggering kubelet’s DiskPressure condition. Evicted pods created a loop.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "TLS handshakes between the API server and a node started failing. Node became NotReady. Investigation showed NTP daemon was down.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A team added a custom rewrite rule in the Corefile which had invalid syntax. CoreDNS failed to start.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A new node was added with a different pod CIDR than what Flannel expected. This broke pod-to-pod and node-to-control-plane communication.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A system admin added custom IPTables NAT rules for external routing, which inadvertently modified the same chains managed by kube-proxy.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A spike in expired certificate renewals caused hundreds of CSRs to queue, none of which were being auto-approved. New nodes waited indefinitely.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "During upgrade, etcd didn’t come up because its pod manifest had a typo. Kubelet never started etcd, causing control plane install to hang.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A debug flag was accidentally enabled in a backend pod, logging hundreds of lines/sec. The journald and container logs filled up all disk space.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A deployment had minAvailable: 2 in PDB, but only 2 pods were running. Node drain couldn’t evict either pod without violating PDB.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "etcd snapshot was restored, but PVCs and secrets weren’t included. Many pods failed to mount or pull secrets.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "New kubelet config missed NO_PROXY=10.0.0.0/8,kubernetes.default.svc, causing internal DNS failures and image pull errors.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A platform team deployed a DaemonSet that set node labels like zone=us-east, but it overwrote custom labels like gpu=true.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A misconfigured deployment had a readiness probe that failed intermittently, making pods seem unready. Cluster Autoscaler detected these as unschedulable, triggering new node provisioning. Once the pod appeared healthy again, Autoscaler would scale down.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The namespace contained resources with finalizers pointing to a deleted controller. Kubernetes waited forever for the finalizer to complete cleanup.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A platform engineer edited the CoreDNS ConfigMap to add a rewrite rule, but introduced a syntax error. The new pods started crashing, and DNS resolution stopped working across the cluster.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A nightly batch job triggered a container image update across thousands of pods. Pulling these images used all available space in /var/lib/containerd, which led to node condition DiskPressure, forcing eviction of critical workloads.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After pod deletion, PVs went into Released state but were never cleaned up due to missing ReclaimPolicy logic. When new PVCs requested the same storage class, provisioning failed.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Platform team added a new node pool with node-role.kubernetes.io/gpu:NoSchedule, but forgot to add tolerations to GPU workloads.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The internal Docker registry was down during node provisioning, so containerd couldn't pull pauseand CNI images. Nodes stayed in NotReady state.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Kubelet uses a client certificate for authentication with the API server. These are typically auto-rotated, but the nodes were offline when the rotation was due.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "An override in the Helm chart introduced an invalid leader election namespace, causing the scheduler to panic and crash on startup.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "New version of Calico enforced stricter iptables drop policies, blocking traffic from CoreDNS to pods.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Token-based authentication failed for all workloads and kubectl access due to time drift between worker nodes and the API server.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Pods using topologySpreadConstraints for zone balancing failed to find valid nodes because some nodes lacked the topology.kubernetes.io/zone label.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Multiple pods opened persistent watch connections and never closed them, overloading the API server.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Pods mounting the kube-root-ca.crt ConfigMap failed to start after deletion. DNS, metrics-server, and other system components failed.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The admission webhook had expired TLS certs, causing validation errors on all resource creation attempts.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A new quota was applied with very low CPU/memory limits. All new pods across namespaces failed scheduling.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After upgrading the control plane, CNI plugins failed to work, resulting in no network connectivity between pods.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Node pool scaling in GKE triggered a rescheduling of StatefulSet pods, breaking persistent volume claims that were tied to specific nodes.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The kubelet on a node crashed after the available memory was exhausted due to pods consuming more memory than allocated.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "DNS queries failed between two federated clusters, preventing services from accessing each other across clusters.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The Horizontal Pod Autoscaler failed to scale the application pods up, even under load, due to insufficient resource limits set on the pods.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A misconfigured audit policy led to high volumes of audit logs being generated, overwhelming the control plane.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Over time, pod distribution became uneven, with some nodes over-committed while others remained underutilized. This caused resource fragmentation, leading to cluster instability.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The backup process failed because the EBS volume snapshot driver was misconfigured, resulting in incomplete backups.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A deployment failed because Kubernetes could not pull images from a custom Docker registry due to misconfigured image pull secrets.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Ingress controller was handling a large number of routes inefficiently, resulting in significant network latency and slow response times for external traffic.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Optimizing ingress routing rules is critical for performance, especially in high-traffic environments.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "During a scheduled node maintenance, draining took longer than expected because pods were not respecting PodDisruptionBudgets.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The cluster became unresponsive after deploying a batch of 500 pods in a single operation, causing resource exhaustion.",
    "diagnosisSteps": [
    ...
    "rootCause": "The large-scale deployment exhausted the cluster’s available resources, causing a spike in API server load.",
  ...
  },
  {
    ...
    "whatHappened": "After a node was drained for maintenance, it failed to rejoin the cluster due to a corrupted kubelet configuration file.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Regular backups of critical configuration files like kubelet configs can save time during node recovery.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "HPA was configured to scale pods based on CPU utilization but had an overly sensitive threshold, causing the application to scale out rapidly and exhaust resources.",
    "diagnosisSteps": [
    ...
    "rootCause": "HPA was too aggressive in scaling up based on CPU utilization, without considering other metrics like memory usage or custom metrics.",
    ...
    "lessonsLearned": "Scaling based on a single metric (e.g., CPU) can lead to inefficiency, especially during workload spikes.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "After a pod was restarted, the application started behaving unpredictably, with some users experiencing different results from others due to lack of state synchronization.",
    "diagnosisSteps": [
    ...
    "rootCause": "The application was not designed to persist state beyond the pod lifecycle, leading to inconsistent behavior after restarts.",
  ...
  },
  {
    ...
    "whatHappened": "A misconfigured automation pipeline accidentally removed a ClusterRoleBinding, which was required for certain critical services to function.",
    "diagnosisSteps": [
    ...
    "rootCause": "Automated pipeline incorrectly removed the ClusterRoleBinding, causing service permissions to be revoked.",
    "fix": "• Restored the missing ClusterRoleBinding.\n• Manually verified that affected services were functioning correctly.",
    "lessonsLearned": "Automation changes must be reviewed and tested to prevent accidental permission misconfigurations.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Due to improper resource requests and limits, the node was overcommitted, which led to the eviction of critical pods.",
    "diagnosisSteps": [
    ...
    "rootCause": "Pods did not have properly set resource requests and limits, leading to resource overcommitment on the node.",
  ...
  },
  {
    ...
    "whatHappened": "The image pull policy was set to Never, preventing Kubernetes from pulling the required container images from the registry.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "The correct image pull policy is necessary to ensure Kubernetes can pull container images from a registry.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Pod scheduling took significantly longer than expected due to excessive resource consumption in the control plane.",
    "diagnosisSteps": [
    ...
    "rootCause": "The default scheduler was not optimized for high resource consumption, causing delays in pod scheduling.",
  ...
  },
  {
    ...
    "whatHappened": "A user attempted to create PVCs that exceeded the available storage quota, leading to failed PVC creation.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "When a node was taken down for maintenance, the pod failed to reschedule due to restrictive node affinity settings.",
    "diagnosisSteps": [
    ...
    "rootCause": "Node affinity rules were set too restrictively, preventing the pod from being scheduled on other nodes.",
  ...
  },
  {
    ...
    "whatHappened": "Pods were being killed and restarted due to the container’s resource requests and limits being set too low, causing OOM (Out of Memory) kills.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "lessonsLearned": "Proper log management and rotation are essential to avoid filling up disk space and impacting cluster performance.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Several CronJobs were triggered simultaneously, causing the cluster to run out of CPU and memory resources.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always add resource limits and configure CronJobs to prevent them from running in parallel and exhausting cluster resources.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A deployment’s pod scaling was unsuccessful due to the anti-affinity rules that conflicted with available nodes.",
    "diagnosisSteps": [
    ...
    "rootCause": "The anti-affinity rule required pods to be scheduled on specific nodes, but there were not enough available nodes.",
    ...
    "lessonsLearned": "Affinity and anti-affinity rules should be configured carefully, especially in dynamic environments with changing node capacity.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The API server started throttling requests because the number of concurrent API calls exceeded the available limit.",
    "diagnosisSteps": [
    ...
    "rootCause": "Clients were making too many API requests in a short period, exceeding the rate limits of the API server.",
  ...
  },
  {
    ...
    "whatHappened": "The request to expand a persistent volume failed because the storage class was not configured to support volume expansion.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Ensure that storage classes are configured to allow volume expansion when using dynamic provisioning.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Pods started with an image tag that did not exist in the container registry, causing the pods to enter a CrashLoopBackOff state.",
    "diagnosisSteps": [
    ...
    "rootCause": "The container image tag specified in the deployment was incorrect or missing from the container registry.",
  ...
  },
  {
    ...
    "whatHappened": "During a high workload period, nodes ran out of resources, causing the scheduler to evict pods and causing disruptions.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Pods were unable to resolve internal service names due to DNS failures, leading to broken inter-service communication.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "PVCs were stuck in the Pending state because the dynamic provisioner could not create the required PVs.",
    "diagnosisSteps": [
    ...
    "rootCause": "Misconfigured storage class settings were preventing the dynamic provisioner from provisioning volumes.",
  ...
  },
  {
    ...
    "whatHappened": "After an update, the deployment was rolled back to a previous image version that was no longer present in the container registry, causing the rollback to fail.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The Kubernetes master node was overwhelmed by API calls and high memory consumption, leading to a failure to respond to management requests.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A pod failed to restart after a node failure because the node affinity rules were too strict, preventing the pod from being scheduled on any available nodes.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "When attempting to scale a ReplicaSet, new pods failed to schedule due to a lack of available resources on the nodes.",
    "diagnosisSteps": [
    ...
    "rootCause": "Insufficient node resources to accommodate new pods due to high resource consumption by existing workloads.",
  ...
  },
  {
    ...
    "whatHappened": "After upgrading the cluster, a namespace that was present before the upgrade was no longer available.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always backup critical resources before performing upgrades and test the upgrade process thoroughly.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "HPA did not scale pods appropriately, either under-scaling or over-scaling, due to incorrect metric definitions.",
    "diagnosisSteps": [
    ...
    "rootCause": "HPA was configured to scale based on inaccurate or inappropriate metrics, leading to inefficient scaling behavior.",
  ...
  },
  {
    ...
    "whatHappened": "Pods failed to pull images because the registry was down for maintenance, leading to deployment failures.",
    "diagnosisSteps": [
    ...
    "rootCause": "The container registry was temporarily unavailable due to maintenance, and the pods could not access the required images.",
  ...
  },
  {
    ...
    "whatHappened": "The pods had very low resource requests, causing the scheduler to fail to assign them to available nodes.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A node ran out of disk space due to logs and other data consuming the disk, resulting in pod evictions.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "When attempting to drain a node, the operation failed because some pods were still in use or had pending termination grace periods.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After a node was rebooted, the networking components failed to re-establish proper connectivity for the pods.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Pods failed to access necessary resources due to misconfigured RBAC policies, resulting in permission-denied errors.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "rootCause": "The pod was using APIs that were deprecated in the new Kubernetes version, causing the upgrade to fail.",
  ...
  },
  {
    ...
    "whatHappened": "An application was running inefficient code that caused excessive CPU consumption, impacting the entire node's performance.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The pods had a slow initialization time, but the readiness probe timeout was set too low, causing premature failure.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "The readiness probe timeout should be configured according to the actual initialization time of the pod.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Ingress was misconfigured with incorrect path mappings, causing requests to certain API routes to return 404 errors.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "When attempting to scale up a node pool, the scaling operation failed due to hitting AWS resource quotas.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A pod configuration required a ConfigMap that was deleted by accident, causing the pod to crash due to missing configuration data.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Excessive logging from the kubelet and other components overwhelmed the API server, causing it to become slow and unresponsive.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The nodes had taints that were not matched by the pod's tolerations, causing the pods to remain unscheduled.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The Kubernetes dashboard was overwhelmed by too many requests, consuming excessive CPU and memory resources.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "rootCause": "The resource limits set for the container were too low, causing the container to be terminated when it exceeded the limit.",
  ...
  },
  {
    ...
    "whatHappened": "A newly applied NetworkPolicy was too restrictive, preventing communication between certain pods within the same namespace.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Network policies need to be tested thoroughly, especially in multi-tenant or complex networking environments.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "CoreDNS pods were crashed due to resource exhaustion, leading to DNS resolution failure for all services.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Services behind a NodePort experienced high latency due to traffic being routed through each node instead of through an optimized load balancer.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The DNS service was unable to resolve names due to resource limits being hit on the CoreDNS pods, causing failures in service discovery.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "One node in the node pool was handling all the traffic for multiple pods, leading to CPU and network saturation.",
    "diagnosisSteps": [
    ...
    "rootCause": "The cluster autoscaler did not scale the node pool correctly due to resource limits on the instance type.",
  ...
  },
  {
    ...
    "whatHappened": "The CNI plugin failed to configure networking correctly, causing network partitions within the cluster.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The Ingress resource had incorrect SSL certificate annotations, causing SSL handshake failures for external traffic.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The cluster autoscaler tried to add nodes to the cluster, but due to insufficient IAM permissions, it was unable to interact with EC2 to provision new instances. This led to insufficient resources, affecting pod scheduling.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Ensure that the cluster autoscaler has the required permissions to scale nodes in cloud environments.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Pods were allocated IPs outside the expected range, causing DNS queries to fail since the DNS service was not able to route correctly.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A service was configured with a port that was already in use by another pod, causing connectivity issues.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The pod was evicted by the kubelet due to network resource limits being exceeded, leading to a failure in service availability.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Network packets were being dropped or fragmented between nodes with different MTU settings, causing network instability.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After scaling up the application pods, the load balancer continued to route traffic to old, terminated pods.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Overlapping IP ranges between the VPC and pod network caused routing issues and dropped traffic between pods and external services.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A misconfigured DNS resolver in the CoreDNS configuration caused service discovery to fail for some internal services.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A network policy was misconfigured, preventing certain pods from communicating with each other despite being within the same namespace.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After deploying a new version of the application, the load balancer’s health checks started failing, causing traffic to be routed to unhealthy pods.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After an upgrade to a node pool, there was significant latency in network communication between pods, impacting application performance.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A new service was assigned an IP within a CIDR range already in use by another service, causing traffic to be routed incorrectly.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Pods in different namespaces experienced significant latency while trying to communicate, causing service timeouts.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After upgrading the CNI plugin, network connectivity between pods was disrupted, causing intermittent traffic drops.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always test new CNI plugin versions in a staging environment before upgrading production clusters.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A misconfiguration in the ingress annotations caused the ingress controller to fail to route external traffic to the correct service.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "During a node pool upgrade, the nodes took longer to drain due to some pods having long graceful termination periods. This caused the upgrade process to time out.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The upgrade to K8s v1.18 was blocked due to deprecated API versions still being used in certain resources, such as extensions/v1beta1 for Ingress and ReplicaSets.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always update API versions to ensure compatibility with new Kubernetes versions before performing upgrades.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "After restarting a pod, the DNS resolution failed for internal services, preventing communication between dependent services.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The application relied on static pod IPs, but after a pod was rescheduled, its IP address changed, causing communication breakdowns.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "As the number of pods increased due to autoscaling, network latency between pods and services spiked, causing slow response times.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The service had a namespaceSelector field configured incorrectly, which caused it to be inaccessible from the intended namespace.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After a network plugin upgrade, some pods lost network connectivity intermittently, affecting communication with other services.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A missing annotation caused the ingress controller to not route external traffic to the right service.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Two pods were assigned the same IP address by the CNI plugin, leading to network issues and service downtime.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After upgrading the Kubernetes cluster, DNS resolution stopped working for certain namespaces, causing intermittent application failures.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "After upgrading the cluster, always validate the configuration of critical components like CoreDNS.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Newly deployed pods in the service mesh were missing their sidecar proxy containers, causing communication failures.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Ensure that required annotations are applied to all pods, or configure the sidecar injector to inject by default.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "During a large-scale application deployment, network traffic consumed all available bandwidth, leading to service timeouts and network packet loss.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After applying a set of network policies, pods in the same namespace could no longer communicate, even though they should have been allowed by the policy.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Network policies need careful management to avoid conflicting rules that can block internal communication.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Network latency increased across pods as the CNI plugin (Flannel) became overloaded with traffic, causing service degradation.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always ensure that the CNI plugin is well-suited to the network load expected in production environments.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Pods in the cluster started experiencing increased latency and timeouts, which was traced back to TCP retransmissions caused by network saturation.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Pods in the same namespace could not communicate because an ingress network policy blocked traffic between them.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "After deploying an application, pod communication became unstable due to misconfiguration in the overlay network.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Two services in different namespaces were configured to use the same port number, causing a conflict in service communication.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "External access to a service using a NodePort was blocked because the cloud provider's firewall rules were too restrictive.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "CoreDNS started experiencing high response times due to CPU and memory resource constraints, leading to DNS resolution delays.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "CoreDNS should be allocated appropriate resources based on expected load, especially in large clusters.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Ensure that MTU settings are consistent across the network stack to avoid performance degradation.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Traffic intended for a specific application was routed to the wrong backend service because the ingress resource had a misconfigured path.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Services failed intermittently because CoreDNS had cached stale DNS records, causing them to resolve incorrectly.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Be cautious of DNS TTL settings, especially in dynamic environments where IP addresses change frequently.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A node failure caused the Flannel CNI plugin to lose its network routes, disrupting communication between pods on different nodes.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Network traffic was dropped because a network policy inadvertently blocked traffic to a port that was required by another application.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "CoreDNS pods exhausted available CPU and memory, leading to service failures and DNS resolution issues.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Ensure that critical components like CoreDNS have sufficient resources allocated for normal operation.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Pods were unable to communicate across nodes because the IPAM configuration was improperly set, causing an address space overlap.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A sudden spike in traffic caused the CNI plugin to become overloaded, resulting in significant packet loss and network latency between pods.",
    "diagnosisSteps": [
    ...
    "rootCause": "The CNI plugin lacked sufficient resources to handle the spike in traffic, leading to packet loss and network degradation.",
    ...
    "lessonsLearned": "Ensure that the CNI plugin is properly sized to handle peak traffic loads, and monitor its health regularly.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "CoreDNS was misconfigured with the wrong upstream DNS resolver, causing DNS lookups to fail and leading to application connectivity issues.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Calico was misconfigured with an incorrect CIDR range, leading to network partitioning where some pods could not reach other pods in the same cluster.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Ensure that network configurations, especially for CNI plugins, are thoroughly tested before deployment.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The pod network subnet overlapped with another network on the host machine, causing IP address conflicts and preventing communication between pods.",
    "diagnosisSteps": [
    ...
    "rootCause": "Incorrect subnet configuration that caused overlapping IP ranges between the Kubernetes pod network and the host network.",
    ...
    "lessonsLearned": "Pay careful attention to subnet planning when setting up networking for Kubernetes clusters to avoid conflicts.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A sudden increase in traffic caused the network interface on the nodes to become overloaded, leading to high network latency between pods and degraded application performance.",
    "diagnosisSteps": [
    ...
    "rootCause": "The network interface on the nodes was unable to handle the high network traffic due to insufficient capacity.",
    ...
    "lessonsLearned": "Ensure that Kubernetes nodes are provisioned with adequate network capacity for expected traffic loads.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Pods experienced intermittent connectivity failures because the DNS cache expired too quickly, causing DNS lookups to fail for external services.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Proper DNS caching settings are critical for maintaining stable connectivity to external services.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Network policies were incorrectly configured, leading to intermittent drops in network connectivity between pods, especially under load.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Ensure that network policies are tested thoroughly before being enforced, especially in production.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "During an upgrade to the CNI plugin, the network was temporarily disrupted due to incorrect version compatibility and missing network configurations.",
    "diagnosisSteps": [
    ...
    "rootCause": "The new version of the CNI plugin required additional configuration settings that were not applied during the upgrade.",
  ...
  },
  {
    ...
    "whatHappened": "The VPC peering between two regions was misconfigured, leading to intermittent network connectivity issues between pods in different regions.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Ensure that all network routing and peering configurations are validated before deploying cross-region clusters.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A network policy was accidentally configured to block DNS (UDP port 53) traffic between pods, preventing DNS resolution and causing services to fail.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The worker nodes were using a single network interface to handle both pod traffic and node communication. The high volume of pod traffic caused the network interface to become overutilized, resulting in slow communication.",
    "diagnosisSteps": [
    ...
    "rootCause": "The network interface on the worker nodes was not properly partitioned to handle separate types of traffic, leading to resource contention.",
    ...
    "lessonsLearned": "Proper network interface design is crucial for handling high traffic loads and preventing bottlenecks.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The VPN tunnel between the Kubernetes cluster in the cloud and an on-premise data center became overloaded, causing increased latency for communication between services located in the two environments.",
    "diagnosisSteps": [
    ...
    "rootCause": "The VPN tunnel was not sized correctly to handle the required traffic between the cloud and on-premise environments.",
    ...
    "lessonsLearned": "Ensure that hybrid network connections like VPNs are appropriately sized and optimized for traffic.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Pods experienced connectivity issues and packet loss because the MTU settings on the nodes and CNI plugin were inconsistent, causing packets to be fragmented and dropped.",
    "diagnosisSteps": [
    ...
    "rootCause": "Inconsistent MTU settings between the CNI plugin and the Kubernetes nodes caused packet fragmentation and loss.",
  ...
  },
  {
    ...
    "whatHappened": "A network policy was incorrectly configured to block communication between namespaces, leading to service failures and inability to reach certain pods.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "CoreDNS pods crashed due to high CPU utilization caused by excessive DNS queries, which prevented service discovery and caused communication failures.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "CoreDNS was misconfigured to not forward DNS queries to external DNS servers, causing pods to fail when resolving services outside the cluster.",
    "diagnosisSteps": [
    ...
    "rootCause": "CoreDNS was not configured to forward external queries, leading to DNS resolution failure for non-cluster services.",
  ...
  },
  {
    ...
    "whatHappened": "CoreDNS pods were handling a high volume of DNS requests without sufficient resources, leading to increased latency and timeouts.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Proper resource allocation and autoscaling are critical for maintaining DNS performance under load.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "In a hybrid cloud setup, the CIDR blocks of the Kubernetes cluster VPC and the on-premise VPC overlapped, causing routing issues that led to network degradation and service disruptions.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A network policy was applied to restrict traffic between namespaces but unintentionally blocked DNS traffic on UDP port 53, causing service discovery to fail.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always carefully test network policies to ensure they don't inadvertently block critical traffic like DNS.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "An overlay network (Flannel) used to connect pods was overwhelmed due to high traffic volume, resulting in intermittent packet drops and network congestion.",
    "diagnosisSteps": [
    ...
    "rootCause": "The overlay network (Flannel) could not handle the traffic load due to insufficient resources allocated to the network component.",
    ...
    "lessonsLearned": "Ensure that network plugins are properly configured and scaled to handle the expected traffic volume.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The Calico CNI plugin configuration was missing the necessary IP pool definitions, which caused pods to fail to obtain IPs from the defined pool, resulting in communication failure between pods.",
    "diagnosisSteps": [
    ...
    "rootCause": "The IP pool was not defined in the Calico CNI plugin configuration, causing pods to be unable to get network addresses.",
  ...
  },
  {
    ...
    "whatHappened": "CoreDNS pods were experiencing sporadic failures due to high CPU utilization. DNS resolution intermittently failed during peak load times.",
    "diagnosisSteps": [
    ...
    "rootCause": "CoreDNS pods were not allocated sufficient CPU resources to handle the DNS query load during peak times.",
    ...
    "lessonsLearned": "CoreDNS should be adequately resourced, and autoscaling should be enabled to handle varying DNS query loads.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The cluster was using Flannel as the CNI plugin, and network latency increased as the overlay network was unable to efficiently handle the traffic between pods and nodes.",
    "diagnosisSteps": [
    ...
    "rootCause": "The Flannel overlay network introduced additional overhead, which caused latency in pod-to-node communication.",
    ...
    "lessonsLearned": "Choose the right CNI plugin based on network performance needs, especially in high-throughput environments.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The DNS resolver cached the old IP addresses for services, causing service discovery failures when the IPs of the services changed.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The regional load balancer was not properly configured to handle traffic between node pools located in different zones, causing network partitioning between pods in different zones.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Ensure proper configuration of load balancers to support multi-zone communication in cloud environments.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The project had requirements for strict pod isolation, but the necessary NetworkPolicy was not created, resulting in unexpected communication between pods that should not have had network access to each other.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The physical network’s MTU was configured differently from the MTU settings in the Kubernetes CNI plugin, causing packet fragmentation. As a result, node-to-node communication was sporadic.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Ensure that the MTU setting in the CNI plugin matches the physical network's MTU to avoid connectivity issues.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The CoreDNS configuration was not optimized for the cluster size, resulting in DNS query timeouts under high load.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "CoreDNS needs to be properly resourced and optimized for performance, especially in large clusters.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The load balancing rules were incorrectly set up for the service, which caused requests to only route to one instance of a microservice, despite the intention to split traffic between two.",
    "diagnosisSteps": [
    ...
    "rootCause": "Misconfigured traffic splitting annotations in the Service definition prevented the load balancer from distributing traffic correctly.",
    ...
    "lessonsLearned": "Always double-check load balancer and service annotations when implementing traffic splitting in a microservices environment.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The Kubernetes cluster spanned multiple Azure regions, but the inter-region networking was not optimized, resulting in significant network latency between pods in different regions.",
    "diagnosisSteps": [
    ...
    "rootCause": "Lack of inter-region network optimization and reliance on default settings led to high latency between regions.",
    ...
    "lessonsLearned": "When deploying clusters across multiple regions, network latency should be carefully managed and optimized.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The services were configured without specifying unique port ranges, and both attempted to use the same port on the same node, leading to port binding issues.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "An egress network policy was too restrictive and blocked traffic from the pods to external services, leading to connectivity issues.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Be mindful when applying network policies, especially egress rules that affect external connectivity.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "After upgrading the Calico CNI plugin, the IP pool configuration was not correctly migrated, which caused pods to lose connectivity to other pods and services.",
    "diagnosisSteps": [
    ...
    "rootCause": "The upgrade process failed to migrate the IP pool configuration, leading to network connectivity issues for the pods.",
    ...
    "lessonsLearned": "Ensure network plugin upgrades are carefully tested and configurations are validated after upgrades.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "After modifying the CNI configuration and reconfiguring IP ranges, external DNS resolution failed for services outside the cluster.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The network plugin was configured with an MTU that did not match the underlying network's MTU, leading to packet fragmentation and slower communication between pods.",
    "diagnosisSteps": [
    ...
    "rootCause": "The MTU setting in the network plugin was too high, causing packet fragmentation and slow communication.",
    ...
    "lessonsLearned": "Ensure that MTU settings are aligned between the network plugin and the underlying network infrastructure.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The network plugin was designed to handle a certain volume of traffic, but when the pod-to-pod communication increased, the plugin was unable to scale efficiently, leading to high CPU consumption.",
    "diagnosisSteps": [
    ...
    "rootCause": "The network plugin was not adequately resourced to handle high traffic spikes, leading to resource exhaustion.",
    ...
    "lessonsLearned": "Network plugins need to be able to scale in response to increased traffic to prevent performance degradation.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The NetworkPolicy intended to isolate communication between namespaces was not enforced because it was misconfigured.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The CoreDNS configuration was updated to use an external resolver, but the external resolver had intermittent issues, leading to service discovery failures.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "External DNS resolvers can introduce reliability issues                                                                                                    ; test these changes carefully.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The CNI plugin was incorrectly configured, allowing pods from different network segments to communicate, violating security requirements.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Network segmentation configurations should be thoroughly reviewed to prevent unauthorized communication.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A malicious actor compromised a DNS record by injecting a false IP address into the CoreDNS cache, causing services to resolve to an incorrect IP.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A service account was granted cluster-admin permissions, which allowed users to access sensitive secrets via kubectl. This led to a security breach when one of the users exploited the permissions.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always follow the principle of least privilege when configuring RBAC for service accounts and users.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A network policy was meant to block communication between pods in different namespaces, but it was misconfigured, allowing unauthorized access between pods.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A container was configured with privileged: true in its security context, which allowed it to gain elevated permissions and access sensitive parts of the node.",
    "diagnosisSteps": [
    ...
    "rootCause": "Misconfigured security context allowed the container to run with elevated privileges, leading to security risks.",
  ...
  },
  {
    ...
    "whatHappened": "The Ingress resource for the Kubernetes dashboard was incorrectly set up to allow external traffic from all IPs, making the dashboard accessible without authentication.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always secure the Kubernetes dashboard by restricting access to trusted IPs or requiring strong authentication.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The microservices were communicating over HTTP instead of HTTPS, and there was no mutual TLS (mTLS) configured for secure communication, making data vulnerable to interception.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A vulnerability in the application caused API keys and secrets to be included in logs, which were not sanitized before being stored in the central logging system.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The PodSecurityPolicy (PSP) was not configured to prevent privilege escalation, allowing containers to run with excessive privileges and exploit vulnerabilities within the cluster.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always configure restrictive PodSecurityPolicies to prevent privilege escalation within containers.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A service account token was leaked through an insecure deployment configuration, allowing attackers to gain unauthorized access to the Kubernetes API server.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A critical vulnerability in one of the base images was discovered after deployment, as no vulnerability scanning tools were used to validate the images before use.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Malicious code was deployed when a container image was pulled from a public registry without being properly signed or verified.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Users without explicit permissions accessed and modified resources in the default namespace because the default namespace was not protected by network policies or RBAC rules.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Avoid using the default namespace for critical resources and ensure that proper access control and isolation are in place.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A critical vulnerability in OpenSSL was discovered after deploying a container that had not been updated to use a secure version of the library.",
    "diagnosisSteps": [
    ...
    "rootCause": "The container image was built with an outdated version of OpenSSL that contained unpatched vulnerabilities.",
    ...
    "lessonsLearned": "Always ensure that containers are built using updated and patched versions of libraries to mitigate known vulnerabilities.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The Kubernetes API server was mistakenly exposed without authentication, allowing external users to query resources without any credentials.",
    "diagnosisSteps": [
    ...
    "rootCause": "The API server was misconfigured to allow unauthenticated access, exposing the cluster to unauthorized requests.",
    ...
    "lessonsLearned": "Always secure the Kubernetes API server and ensure proper authentication is in place to prevent unauthorized access.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The nodes in the cluster were not properly hardened according to security best practices, leaving them vulnerable to potential exploitation.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "An ingress resource was misconfigured, exposing sensitive internal services such as the Kubernetes dashboard and internal APIs to the public.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Sensitive environment variables containing credentials were directly included in Kubernetes deployment YAML files, making them visible to anyone with access to the deployment.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Sensitive data should always be stored securely in Kubernetes Secrets or external secret management systems.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A container without resource limits was able to consume all available CPU and memory on the node, causing other containers to become unresponsive and leading to a denial-of-service (DoS).",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always define resource requests and limits to ensure containers do not overconsume resources and cause instability.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Logs were stored in plain text and exposed to users who should not have had access, revealing sensitive data like error messages and stack traces.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The Kubernetes cluster was configured to pull images from an untrusted Docker registry, which lacked proper security measures such as image signing or vulnerability scanning.",
    "diagnosisSteps": [
    ...
    "rootCause": "Using an insecure registry without proper image signing and scanning introduced the risk of malicious images.",
  ...
  },
  {
    ...
    "whatHappened": "The absence of strict Pod Security Policies allowed containers to run with elevated privileges, leading to a potential security risk as malicious pods could gain unauthorized access to node resources.",
    "diagnosisSteps": [
    ...
    "rootCause": "Weak or missing Pod Security Policies allowed privileged containers to be deployed without restriction.",
    ...
    "lessonsLearned": "Strict Pod Security Policies are essential for securing containers and limiting the attack surface.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The Kubernetes Dashboard was deployed without proper access control or authentication mechanisms, leaving it open to the internet and allowing unauthorized users to access sensitive cluster data.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always secure the Kubernetes Dashboard with authentication and limit access using network policies.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Sensitive application traffic was served over HTTP rather than HTTPS, allowing attackers to potentially intercept or manipulate traffic.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always use HTTPS for secure communication between clients and Kubernetes applications, especially for sensitive data.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Network policies were overly permissive, allowing services within the cluster to communicate with each other without restriction. This made it easier for attackers to move laterally if they compromised one service.",
    "diagnosisSteps": [
    ...
    "rootCause": "Permissive network policies allowed unnecessary communication between services, increasing the potential attack surface.",
    ...
    "lessonsLearned": "Proper network segmentation and restrictive network policies are crucial for securing the internal traffic between services.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Sensitive data such as database passwords and API keys were stored as environment variables in plain text within Kubernetes pod specifications, making them accessible to anyone who had access to the pod's configuration.",
    "diagnosisSteps": [
    ...
    "rootCause": "Sensitive data was stored insecurely in environment variables rather than using Kubernetes Secrets or an external secrets management solution.",
    ...
    "lessonsLearned": "Always store sensitive data securely using Kubernetes Secrets or an external secrets management solution, and avoid embedding it in plain text.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The RBAC configurations were not properly set up, granting more permissions than necessary. As a result, unauthorized users were able to access sensitive resources such as secrets, config maps, and deployments.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "RBAC should be configured according to the principle of least privilege to minimize security risks.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "An ingress controller was deployed with insufficient security hardening and exposed to the public internet, making it a target for potential exploits.",
    "diagnosisSteps": [
    ...
    "rootCause": "Insufficient security configurations on the ingress controller allowed it to be exposed to the internet.",
    ...
    "lessonsLearned": "Always secure ingress controllers with authentication and limit access using network policies or IP whitelisting.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The container images used in the cluster had not been updated with the latest security patches, making them vulnerable to known exploits.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Regular updates to container images are essential for maintaining security and reducing the risk of vulnerabilities.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The Kubelet API was inadvertently exposed to the internet without authentication, making it possible for unauthorized users to access sensitive node information, such as pod logs and node status.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always secure the Kubelet API with authentication and restrict access to trusted IPs or internal networks.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Security-related events, such as privilege escalations and unauthorized access attempts, were not being logged correctly due to misconfigurations in the auditing system.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Properly configuring audit logging is essential for detecting potential security incidents and ensuring compliance.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The RBAC configuration allowed developers to assume roles with cluster admin privileges, enabling them to access and modify sensitive resources, including secrets and critical configurations.",
    "diagnosisSteps": [
    ...
    "rootCause": "Misconfigured RBAC roles allowed developers to acquire cluster admin privileges, leading to unnecessary access to sensitive resources.",
    ...
    "lessonsLearned": "Always follow the principle of least privilege when assigning roles, and regularly audit RBAC configurations to prevent privilege escalation.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A service account used by multiple pods had broader permissions than needed. This allowed one compromised pod to access sensitive resources across the cluster, including secrets and privileged services.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "Secrets were mounted directly into the filesystem of pods, making them accessible to anyone with access to the pod's filesystem, including attackers who compromised the pod.",
    "diagnosisSteps": [
    ...
    "rootCause": "Secrets were mounted without sufficient access control, allowing them to be exposed in the pod filesystem.",
  ...
  },
  {
    ...
    "whatHappened": "The API server authorization mechanisms were misconfigured, allowing unauthorized users to bypass RBAC rules and access sensitive cluster resources.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Properly configuring the Kubernetes API server’s authorization mechanism is crucial for cluster security.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The credentials used to access the container image registry were stored in plaintext in a config map, and these credentials were stolen by an attacker, who then pulled a malicious container image into the cluster.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Sensitive credentials should never be stored in plaintext                                                                                                                                                           ; Kubernetes Secrets provide secure storage.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The Kubernetes API server was configured to allow access from external IP addresses without proper security measures such as encryption or authentication, which could be exploited by attackers.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always secure the Kubernetes API server with proper network restrictions, encryption, and authentication.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Admission controllers were either not enabled or misconfigured, allowing users to create resources without enforcing security standards, such as running containers with privileged access or without required security policies.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Admission controllers are essential for enforcing security standards and preventing insecure resources from being created.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The cluster lacked a comprehensive auditing and monitoring solution, and there were no alerts configured for sensitive security events, such as privilege escalations or suspicious activities.",
    "diagnosisSteps": [
    ...
    "rootCause": "Absence of audit logging and real-time monitoring prevented timely detection of potential security issues.",
    ...
    "lessonsLearned": "Continuous monitoring and auditing are essential for detecting and responding to security incidents.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A load balancer was misconfigured, exposing internal services to the public internet without proper access controls, increasing the risk of unauthorized access.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always secure internal services exposed via load balancers by applying strict access controls and authentication.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Secrets were transmitted over an unsecured network connection between pods and the Kubernetes API server, allowing an attacker to intercept the data.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always encrypt traffic between Kubernetes components, especially when transmitting sensitive data like secrets.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The PodSecurityPolicy (PSP) feature was disabled or misconfigured, allowing pods with privileged access to be deployed. This opened up the cluster to potential privilege escalation and security vulnerabilities.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Enforcing PodSecurityPolicies is crucial for securing pod configurations and preventing risky deployments.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The Kubernetes cluster nodes were running outdated operating system versions with unpatched security vulnerabilities. These vulnerabilities were exploited in a targeted attack, compromising the nodes and enabling unauthorized access.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Regular patching of Kubernetes nodes and underlying operating systems is essential for preventing security exploits.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Insufficient network policies were in place, allowing all pods to communicate freely with each other. This enabled attackers who compromised one pod to move laterally across the cluster and access additional services.",
    "diagnosisSteps": [
    ...
    "rootCause": "Lack of restrictive network policies allowed unrestricted traffic between pods, increasing the attack surface.",
    ...
    "lessonsLearned": "Proper network segmentation with Kubernetes network policies is essential to prevent lateral movement in case of a breach.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The Kubernetes Dashboard was exposed to the public internet without proper authentication or authorization mechanisms, allowing attackers to view sensitive cluster information and even execute actions like deploying malicious workloads.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always secure the Kubernetes Dashboard with proper authentication mechanisms and limit exposure to trusted users.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Containers were pulled from an untrusted registry that did not implement image scanning. These images had known security vulnerabilities, which were exploited once deployed in the cluster.",
    "diagnosisSteps": [
    ...
    "rootCause": "Use of untrusted and insecure container images led to the deployment of containers with vulnerabilities.",
  ...
  },
  {
    ...
    "whatHappened": "TLS certificates used for internal communication between Kubernetes components were either expired or misconfigured, leading to insecure communication channels.",
    "diagnosisSteps": [
    ...
    "rootCause": "Expired or misconfigured TLS certificates allowed unencrypted communication between Kubernetes components.",
  ...
  },
  {
    ...
    "whatHappened": "Service accounts were assigned broad permissions that allowed them to perform sensitive actions, such as modifying cluster configurations and accessing secret resources.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Service accounts should follow the principle of least privilege to limit the impact of any compromise.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The logging setup was not configured to redact sensitive data, and logs containing authentication tokens and private keys were accessible to unauthorized users.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always ensure that sensitive data in logs is either redacted or filtered to prevent unintentional exposure.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Kubernetes components and applications in the cluster were using deprecated APIs, which were no longer supported and contained known security issues. The attacker exploited these vulnerabilities to gain unauthorized access to sensitive resources.",
    "diagnosisSteps": [
    ...
    "rootCause": "Outdated and deprecated APIs were used, exposing the cluster to security vulnerabilities that were no longer patched.",
    ...
    "lessonsLearned": "Always stay current with supported APIs and avoid using deprecated versions that may not receive security patches.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Many pods in the cluster were deployed without specifying a security context, leading to some containers running with excessive privileges, such as access to the host network or running as root. This allowed attackers to escalate privileges if they were able to compromise a container.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A vulnerability in the container runtime was exploited by an attacker, who was able to execute arbitrary code on the host node. This allowed the attacker to escape the container and execute malicious commands on the underlying infrastructure.",
    "diagnosisSteps": [
    ...
    "rootCause": "An unpatched vulnerability in the container runtime allowed an attacker to escape the container and gain access to the host.",
    ...
    "lessonsLearned": "Regularly update the container runtime and other components to mitigate the risk of known vulnerabilities.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A new RBAC policy was applied, which inadvertently restricted the cluster admin’s ability to manage critical components such as deployments, services, and namespaces. This caused operational issues and hindered the ability to scale or fix issues in the cluster.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "A cluster had PodSecurityPolicies enabled, but the policies were too permissive, allowing containers with root privileges and host network access. Attackers exploited these permissions to escalate privileges within the cluster.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "It is crucial to configure PodSecurityPolicies with the least privilege principle to prevent privilege escalation.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A developer mistakenly included the service account token in a pod environment variable, making it accessible to anyone with access to the pod. The token was then exploited by attackers to gain unauthorized access to the Kubernetes API.",
    "diagnosisSteps": [
    ...
    "rootCause": "Service account token was inadvertently exposed in the pod's environment variables, allowing attackers to use it for unauthorized access.",
    ...
    "lessonsLearned": "Never expose sensitive credentials like service account tokens in environment variables or in pod specs.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A container running an outdated image with known vulnerabilities was exploited. The attacker used this vulnerability to gain access to the underlying node and execute malicious commands.",
    "diagnosisSteps": [
  ...
  },
  {
    ...
    "whatHappened": "The lack of restrictive network policies allowed any pod to communicate with any other pod in the cluster, even sensitive ones. After a pod was compromised, the attacker moved laterally to other pods and services, leading to further compromise.",
    "diagnosisSteps": [
    ...
    "rootCause": "Insufficient network policies allowed unrestricted traffic between pods, increasing the potential for lateral movement.",
    ...
    "lessonsLearned": "Strong network segmentation is essential to contain breaches and limit the potential for lateral movement within the cluster.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Some internal communications between services in the cluster were not encrypted, which exposed sensitive information during transit. This could have been exploited by attackers using tools to intercept traffic.",
    "diagnosisSteps": [
    ...
    "rootCause": "Lack of encryption in communication between internal services, resulting in unprotected data being transmitted over the network.",
    ...
    "lessonsLearned": "Never allow sensitive data to be transmitted in plaintext across the network. Always enforce encryption.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A service was inadvertently exposed to the internet via an external LoadBalancer, which was not secured. Attackers were able to send requests directly to the service, attempting to exploit vulnerabilities.",
    "diagnosisSteps": [
    ...
    "lessonsLearned": "Always secure services exposed via LoadBalancer by restricting public access or using proper authentication mechanisms.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "Several containers were deployed with the privileged: true flag, but no seccomp or AppArmor profiles were applied. These containers had unrestricted access to the host kernel, which could lead to security breaches if exploited.",
    "diagnosisSteps": [
    ...
    "rootCause": "Running privileged containers without applying restrictive security profiles (e.g., seccomp, AppArmor) exposes the host to potential exploitation.",
    ...
    "lessonsLearned": "Avoid running containers with excessive privileges. Always apply security profiles to limit the scope of potential attacks.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "A container image from an untrusted registry was pulled and deployed. The image contained malicious code, which was executed once the container started. The attacker used this to gain unauthorized access to the cluster.",
    "diagnosisSteps": [
    ...
    "rootCause": "The use of an untrusted container registry allowed the deployment of a malicious container image, which compromised the cluster.",
    ...
    "lessonsLearned": "Only use container images from trusted sources, and always scan images for vulnerabilities before deployment.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "whatHappened": "The ingress controller was configured without proper access controls, allowing external users to directly access internal services. Attackers were able to target unprotected services within the cluster.",
    "diagnosisSteps": [
    ...
    "rootCause": "Ingress controller misconfiguration allowed external access to internal services without proper authentication or authorization.",
    ...
    "lessonsLearned": "Always configure ingress controllers with proper access control mechanisms to prevent unauthorized access to internal services.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Always review and harden default configurations of Ingress controllers to prevent unintended exposure.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Clearly define security contexts for all containers, especially those requiring elevated privileges.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Don’t give more access than necessary                                                                                                                                                                ; disable token mounts where not needed.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Be mindful of what gets logged                                                                                                ; logs can become a liability.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Not all clones are deep copies                                                                                                                                                                                  ; understand your CSI plugin's clone semantics.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "rootCause": "Snapshot GC controller didn’t remove finalizers due to missing permissions in Velero's service account.",
  ...
  },
  {
    ...
    "rootCause": "No upper limit on replica count during load test                           ; hit cloud provider limits.",
  ...
  },
  {
    ...
    "lessonsLearned": "Memory issues can trigger excessive scaling                                             ; proper monitoring is critical.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "rootCause": "Resource requests were misconfigured, leading to a mismatch between node capacity and pod requirements.",
  ...
  },
  {
    ...
    "lessonsLearned": "StatefulSets are not suitable for all workloads, particularly those needing efficient horizontal scaling.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Autoscaling policies need to be tuned to handle gradual traffic increases, not just sudden bursts.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Ensure that the cluster has sufficient resources or can scale horizontally when pod demands increase.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Memory pressure must be monitored and managed effectively during scaling events to avoid pod scheduling failures.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "rootCause": "Fragmented resources, where existing nodes had unused capacity but could not schedule new pods due to resource imbalances.",
  ...
  },
  {
    ...
    "lessonsLearned": "Memory pressure is a critical factor in scaling, and it should be carefully considered during node provisioning.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Cluster Autoscaler configuration should be fine-tuned to better handle all types of node utilization scenarios.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "rootCause": "Aggressive scaling triggers in HPA, without sufficient resource constraints to handle rapid pod scaling.",
    ...
    "lessonsLearned": "Scaling policies should be configured with a balance between responsiveness and resource availability.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "rootCause": "Misconfigured pod affinity/anti-affinity rules and insufficient diversification in the node pool setup.",
  ...
  },
  {
    ...
    "lessonsLearned": "Scaling based on a single metric can be inadequate during peak loads, especially if there is a delay in detecting resource spikes.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "rootCause": "Misconfigured pod affinity rules that restricted pod placement to only certain nodes, leading to resource bottlenecks.",
  ...
  },
  {
    ...
    "rootCause": "Cluster Autoscaler configuration was too conservative and did not scale nodes quickly enough to accommodate sudden load spikes.",
    ...
    "lessonsLearned": "Autoscalers need to be configured to respond quickly to load fluctuations, especially during peak traffic periods.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Properly provisioning nodes for the expected workload is critical, especially during scaling events.",
    "howToAvoid": [
  ...
  },
  {
    ...
    "lessonsLearned": "Load balancer configurations should be dynamic to accommodate changes in pod count during scaling.",
    "howToAvoid": [
